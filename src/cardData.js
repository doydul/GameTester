export const initialDeck = [
  ...
  { type: 'Item', title: "arcane amulet", cost: '6 Gold', description: "+4 max mana", count: 2 },
  ...
  { type: 'Item', title: "full plate", cost: '6 Gold', description: "+4 max hp", count: 2 },
  { type: 'Item', victoryPoints: 10, title: "crown of nobility", cost: '25 Gold', description: "10 Victory Points. Cannot be played for free or transmuted", count: 1 },
  ...
  // Spells
  { type: 'Spell', title: "fireball", cost: '3 Mana', description: "add 6 to strength", count: 4 },
  { type: 'Spell', title: "counterspell", cost: '3 Mana', description: "Reaction: counter a spell or scroll", count: 4 },
  { type: 'Spell', title: "turn to rust", cost: '3 Mana', description: "destroy a weapon that has at least 1 damage on it", count: 2 },
  { type: 'Spell', title: "zap", cost: '3 Mana', description: "deal 3 damage to a player", count: 2 },
  ...
  // Scrolls
  { type: 'Spell - Scroll', title: "cone of frost", cost: '2 Mana', description: "Reaction: add 3 to strength", count: 4 },
  ...
  { type: 'Spell - Scroll', title: "prismatic ray", cost: '4 Mana', description: "Reaction: add 5 to strength", count: 2 },
  { type: 'Spell - Scroll', title: "divination", cost: '2 Mana', description: "draw 2 cards", count: 2 },
...
export const initialAdventureDeck = [
  { type: 'Adventure', victoryPoints: 1, title: "The Sunken Catacombs", cost: 'Discard 2 cards, 2 Damage', description: "1 Victory Point, take 2 from discard pile", count: 2 },
  
  { type: 'Adventure', victoryPoints: 0, title: "An Audience with the King", cost: '15 Gold, Discard 3 cards', description: "6 Victory Point", count: 1 },
  { type: 'Adventure', victoryPoints: 0, title: "Gross Swamp", cost: '3 Damage', description: "3 Gold, Draw 1 card", count: 3 },
  { type: 'Adventure', victoryPoints: 1, title: "Arcane Library", cost: 'Discard 2 cards', description: "1 Victory Point, Draw 2 Cards, 5 Mana", count: 3 },
  { type: 'Adventure', victoryPoints: 3, title: "labyrinth", cost: '3 Strength, Discard 6 cards', description: "3 Victory Points, play 1 item from hand for free", count: 1 },
  { type: 'Adventure', victoryPoints: 1, title: "journey through the enchanted forest", cost: '4 Strength', description: "1 Victory Points, 2 Gold, 3 Mana", count: 3 },
  { type: 'Adventure', victoryPoints: 1, title: "goblin nest", cost: '4 Strength', description: "1 Victory Points, 3 Gold", count: 3 },
  { type: 'Adventure', victoryPoints: 1, title: "abandoned town", cost: '3 Strength', description: "1 Victory Points, 1 Gold, draw 2 cards", count: 3 },
  { type: 'Adventure', victoryPoints: 2, title: "orc camp", cost: '5 Strength', description: "2 Victory Points, 3 Gold", count: 3 },
  { type: 'Adventure', victoryPoints: 2, title: "troll cave", cost: '6 Strength', description: "2 Victory Points, 5 Gold", count: 2 },
  { type: 'Adventure', victoryPoints: 2, title: "undead tomb", cost: '6 Strength', description: "take 1 damage, 2 Victory Points, 2 Gold, take 1 card from discard pile", count: 2 },
  { type: 'Adventure', victoryPoints: 2, title: "ogre mound", cost: '7 Strength', description: "2 Victory Points, 6 Gold", count: 2 },
  { type: 'Adventure', victoryPoints: 3, title: "witch's lair", cost: '7 Strength, 2 Damage', description: "3 Victory Points, 2 Gold, 6 Mana", count: 1 },
  { type: 'Adventure', victoryPoints: 3, title: "mage's tower", cost: '8 Strength, 3 Mana', description: "3 Victory Points, draw 3 cards", count: 1 },
  { type: 'Adventure', victoryPoints: 4, title: "battle the lich", cost: '10 Strength, 2 Mana, 3 Damage', description: "4 Victory Points, take 2 cards from discard pile", count: 1 },
  { type: 'Adventure', victoryPoints: 6, title: "dragon hoard", cost: '15 Strength', description: "6 Victory Points, 12 Gold", count: 1 },
  { type: 'Adventure', victoryPoints: 10, title: "Slay the Ancient Evil", cost: '22 Strength', description: "10 Victory Points", count: 1 },
  { type: 'Adventure', victoryPoints: 3, title: "battle of the 12 clans", cost: '8 Strength', description: "3 Victory Points, 3 Gold, all other players take 2 damage", count: 1 },
];
