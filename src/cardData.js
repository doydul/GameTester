export const initialDeck = [
  ...
  { type: 'Item', title: "Arcane Amulet", cost: '2 Gold', description: "+2 max Mana", count: 2 },
  { type: 'Item', title: "Leather Armour", cost: '2 Gold', description: "+3 max hp", count: 3 },
  ...
  { type: 'Item - Weapon', title: "Halberd", cost: '6 Gold', description: "4 Strength", durability: 2, count: 3 },
  ...
  // Spells
  { type: 'Spell', title: "Magic Missile", cost: '1/2/3 Mana', description: "Reaction: add 4/9/12 Strength", count: 4 },
  { type: 'Spell', title: "Fireball", cost: '2/3/4 Mana', description: "Reaction: add 8/13/17 Strength", count: 4 },
  ...
  { type: 'Spell', title: "Zap", cost: '1/2/3 Mana', description: "Deal 2/3/4 Damage to a player", count: 3 },
...
export const initialAdventureDeck = [
  { type: 'Adventure', victoryPoints: 1, title: "", cost: '6 Strength', description: "1 VP, 7 Gold", count: 3 },
  { type: 'Adventure', victoryPoints: 1, title: "", cost: '7 Strength', description: "1 VP, 8 Gold", count: 3 },
  { type: 'Adventure', victoryPoints: 1, title: "", cost: '8 Strength', description: "1 VP, 9 Gold", count: 4 },
  { type: 'Adventure', victoryPoints: 1, title: "", cost: '9 Strength', description: "1 VP, 10 Gold", count: 4 },
  { type: 'Adventure', victoryPoints: 2, title: "", cost: '10 Strength', description: "2 VP, 11 Gold", count: 3 },
  { type: 'Adventure', victoryPoints: 2, title: "", cost: '11 Strength', description: "2 VP, 12 Gold", count: 3 },
  { type: 'Adventure', victoryPoints: 2, title: "", cost: '12 Strength', description: "2 VP, 13 Gold", count: 3 },
  { type: 'Adventure', victoryPoints: 3, title: "", cost: '13 Strength', description: "3 VP, 14 Gold", count: 2 },
  { type: 'Adventure', victoryPoints: 3, title: "", cost: '14 Strength', description: "3 VP, 15 Gold", count: 2 },
  { type: 'Adventure', victoryPoints: 3, title: "", cost: '15 Strength', description: "3 VP, 16 Gold", count: 2 },
  { type: 'Adventure', victoryPoints: 4, title: "", cost: '16 Strength', description: "4 VP, 17 Gold", count: 1 },
  { type: 'Adventure', victoryPoints: 4, title: "", cost: '17 Strength', description: "4 VP, 18 Gold", count: 1 },
  { type: 'Adventure', victoryPoints: 5, title: "", cost: '18 Strength', description: "5 VP, 19 Gold", count: 1 },
  { type: 'Adventure', victoryPoints: 6, title: "", cost: '20 Strength', description: "8 VP, 10 Gold", count: 1 },
  
  { type: 'Adventure', victoryPoints: 1, title: "", cost: '4 Strength, 2 Item Cards', description: "1 VP, 4 Gold, 1 Mana", count: 3 },
  { type: 'Adventure', victoryPoints: 1, title: "", cost: '1 Gold, 3 Cards, 2 Damage', description: "1 VP, 5 Gold, 2 Cards from deck or discard", count: 3 },
  { type: 'Adventure', victoryPoints: 1, title: "", cost: '3 Damage, 4 Strength', description: "1 VP, 4 Gold, 3 Cards, 1 Mana", count: 4 },
  { type: 'Adventure', victoryPoints: 1, title: "", cost: '9 Strength', description: "1 VP, 1 Gold, 1 Card, 3 Mana", count: 4 },
  { type: 'Adventure', victoryPoints: 2, title: "", cost: '2 Spell Cards, 2 Mana', description: "2 VP, 10 Gold, 1 Card from deck or discard", count: 3 },
  { type: 'Adventure', victoryPoints: 2, title: "", cost: '2 Gold, 5 Cards, 2 Damage', description: "2 VP, 3 Gold, 2 Cards, 2 Mana", count: 3 },
  { type: 'Adventure', victoryPoints: 2, title: "", cost: '1 Mana, 8 Strength', description: "2 VP, 11 Gold, 1 Card from deck or discard", count: 3 },
  { type: 'Adventure', victoryPoints: 3, title: "", cost: '4 Gold, 3 Action Cards, 2 Damage', description: "3 VP, 4 Cards, 3 Mana", count: 2 },
  
  { type: 'Adventure', victoryPoints: 1, title: "", cost: '2 Damage', description: "1 VP, 1 Card from deck or discard", count: 3 },
  { type: 'Adventure', victoryPoints: 1, title: "", cost: '3 Damage', description: "1 VP, 1 Card from deck or discard, 1 Mana", count: 2 },
  
  { type: 'Adventure', victoryPoints: 1, title: "", cost: '3 Cards, 1 Damage', description: "1 VP, 5 Gold", count: 2 },
  
  { type: 'Adventure', victoryPoints: 1, title: "", cost: '3 Action Cards, 20 Strength', description: "10 VP, 4 Gold", count: 1 },
  { type: 'Adventure', victoryPoints: 1, title: "", cost: '7 Cards, 12 Strength', description: "10 VP, 4 Gold", count: 1 },
  { type: 'Adventure', victoryPoints: 1, title: "", cost: '3 Spell Cards, 5 Mana', description: "10 VP, 4 Gold", count: 1 },
  { type: 'Adventure', victoryPoints: 1, title: "", cost: '3 Item Cards, 18 Gold', description: "10 VP, 4 Gold", count: 1 },
